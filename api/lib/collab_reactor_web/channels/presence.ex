defmodule CollabReactorWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule CollabReactor.MyChannel do
        use CollabReactorWeb, :channel
        alias CollabReactor.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :collab_reactor,
                        pubsub_server: CollabReactor.PubSub
end
